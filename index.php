...
<!--<a href="index.php" class="site-logo"><img src="assets/img/logo.png" alt="logo"></a>--> 
    ...
    <div id="hero" class="hero">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                <hr>
                    <h1>Syed Zaman Mostafiz</h1>
                    <div class="page-scroll">
                        <p class="job-title">Web Designer and Developer</p>
                        <a href="https://www.fiverr.com/webdeveloperzam" target="_blank" class="btn btn-fill ">Hire me from fiverr</a>
                        <div class="clearfix visible-xxs"></div>
                        <a href="https://www.freelancer.com/u/zamanwebdev" target="_blank" class="btn btn-border">Hire me from freelancer</a>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="service">
                            ...
                            <h4>Front-end</h4>
                            <p>I have experience in HTML5, CSS3 and Javascript with jQuery using Bootstrap Framwork.By using this technology I can design your fornt-end page</p>
                        </div><!-- /.service -->
                    </div>
                    <div class="col-sm-4">
                        <div class="service">
                            ...
                            <h4>Back-end</h4>
                            <p>Using HTML5, CSS3 and Javascript with jQuery techlology I can also design your Back-end Page</p>
                        </div><!-- /.service -->
                    </div>
                    <div class="col-sm-4">
                        <div class="service">
                            ...
                            <h4>PSD to HTML</h4>
                            <p>As well as providing your PSD file, I can also help you to creating a design PSD to HTML,CSS, Javascript using Bootstrap.</p>
                        </div><!-- /.service -->
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-6">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-item-info">
                                <h4>Website Using Bootstrap</h4>
                                <a href="#" data-toggle="modal" data-target="#portfolioItem1"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <a href="projects/WebsiteUsingBootstrap" target="_blank"><span class="glyphicon glyphicon-link"></span></a>
                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-item-info">
                                <h4>Calculator Using Html & Css Title</h4>
                                <a href="#" data-toggle="modal" data-target="#portfolioItem2"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <a href="projects/CalculatorHtmlCss" target="_blank"><span class="glyphicon glyphicon-link"></span></a>
                            </div><!-- /.portfolio-item-info -->
                        </div><!-- /.portfolio-item -->
                    </div>
                    <div class="col-md-4 col-xs-6">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-item-info">
                                <h4>Website Design By Bootstrap</h4>
                                <a href="#" data-toggle="modal" data-target="#portfolioItem3"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <a href="projects/WebsiteDesignByBootstrap" target="_blank"><span class="glyphicon glyphicon-link"></span></a>
                            </div><!-- /.portfolio-item-info -->
                        </div><!-- /.portfolio-item -->
                    </div>
                    <div class="col-md-4 col-xs-6">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-item-info">
                                <h4>Calculator Using JavaScript</h4>
                                <a href="#" data-toggle="modal" data-target="#portfolioItem4"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <a href="projects/CalculatorUsingJavaScript" target="_blank"><span class="glyphicon glyphicon-link"></span></a>
                            </div><!-- /.portfolio-item-info -->
                        </div><!-- /.portfolio-item -->
                    </div>
                    <div class="col-md-4 col-xs-6">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-item-info">
                                <h4>Calculator Using jQuery</h4>
                                <a href="#" data-toggle="modal" data-target="#portfolioItem5"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <a href="projects/CalculatorUsingjQuery" target="_blank"><span class="glyphicon glyphicon-link"></span></a>
                            </div><!-- /.portfolio-item-info -->
                        </div><!-- /.portfolio-item -->
                    </div>
                    <div class="col-md-4 col-xs-6">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-item-info">
                                <h4>PSD to HTML Project</h4>
                                <a href="#" data-toggle="modal" data-target="#portfolioItem6"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <a href="projects/psdtohtmlp04" target="_blank"><span class="glyphicon glyphicon-link"></span></a>
                            </div><!-- /.portfolio-item-info -->
                        </div><!-- /.portfolio-item -->
                    </div>
                </div>
                        ...
                        <b>
                            ...
                            <div class="col-sm-6">
                                <p>
                                    ...
                                    <span>zamanwebdev@gmail.com</span>
                                </p>   
                            </div>
                            <div class="col-sm-12">
                                <p>
                                    <i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp;&nbsp;
                                    <span>Moddho Balubari, Dinajpur Sadar, Dinajpur-5200</span>                   
                                </p>                                
                                
                            </div>
                            </b>
                            <div class="col-sm-12">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4277.866138443505!2d88.63654505292506!3d25.630082566428676!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fb5330bb644813%3A0xe9588a2048824fc1!2zQXphZCBTdG9yZSDgpobgppzgpr7gpqYg4Ka44KeN4Kaf4KeL4Kaw!5e0!3m2!1sen!2sbd!4v1593617745910!5m2!1sen!2sbd" width="410" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>  
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <form>
                            ...
                            <button href="#abut" class="btn btn-border" type="submit">Hire Me <span class="glyphicon glyphicon-send"></span></button>
                        </form>
                    </div>
                </div>
    ...
    <footer id="colophon" class="site-footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-4 col-xs-12">
                    <a class="icon facebook-bg" href="https://www.facebook.com/ZamanFullStackWebDeveloper" target="_blank"><i class="icon-facebook"></i></a>
                    <a class="icon twitter-bg" href="https://twitter.com/zamanwebdevelo1" target="_blank"><i class="icon-twitter"></i></a>
                    <a class="icon gplus-bg" href="https://www.linkedin.com/in/zamanfullstackwebdeveloper/" target="_blank"><i class="icon-linkedin"></i></a>
<!--                     <a class="icon linkedin-bg" href="#"><i class="icon-gplus"></i></a>
 -->                </div>
                <div class="col-sm-4 col-sm-offset-0 col-xs-6 col-xs-offset-3">
                    <p class="copyright">2020 &copy; Syed Zaman Mostafiz</p>
                </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h4 class="modal-title">Website Using Bootstrap</h4>
          ...
          <div class="modal-footer">
            <a href="projects/WebsiteUsingBootstrap" target="_blank" class="btn btn-fill">Visit Page</a>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div id="portfolioItem2" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h4 class="modal-title">Calculator Using Html & Css</h4>
            <!-- <p></p> -->
          </div>
          <div class="modal-footer">
            <a href="projects/CalculatorHtmlCss" target="_blank" class="btn btn-fill">Visit Page</a>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div id="portfolioItem3" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h4 class="modal-title">Website Design By Bootstrap</h4>
            <!-- <p></p> -->
          </div>
          <div class="modal-footer">
            <a href="projects/WebsiteDesignByBootstrap" target="_blank" class="btn btn-fill">Visit Page</a>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div id="portfolioItem4" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h4 class="modal-title">Calculator Using JavaScript</h4>
            <!-- <p></p> -->
          </div>
          <div class="modal-footer">
            <a href="projects/CalculatorUsingJavaScript" target="_blank" class="btn btn-fill">Visit Page</a>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div id="portfolioItem5" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h4 class="modal-title">Calculator Using jQuery</h4>
            <!-- <p></p> -->
          </div>
          <div class="modal-footer">
            <a href="projects/CalculatorUsingjQuery" target="_blank" class="btn btn-fill">Visit Page</a>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div id="portfolioItem6" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h4 class="modal-title">PSD to HTML Project</h4>
            <!-- <p></p> -->
          </div>
          <div class="modal-footer">
            <a href="projects/psdtohtmlp04" target="_blank" class="btn btn-fill">Visit Page</a>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
